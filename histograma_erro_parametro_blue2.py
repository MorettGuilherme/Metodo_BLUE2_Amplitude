...
# Objetivo do código: análise do erro de estimação da amplitude central pelo método Best Linear Unbiased Estimator (BLUE 2).
...
def histograma_erro_estimacao_amplitude_BLUE2(lista_erro_estimacao_amplitude, media_erro_estimacao_amplitude, var_erro_estimacao_amplitude, desvio_padrao_erro_estimacao_amplitude):
...
def principal_histograma_erro_estimacao_amplitude_BLUE2():
    ...
    histograma_erro_estimacao_amplitude_BLUE2(lista_erro_estimacao_amplitude, media_erro_estimacao_amplitude, var_erro_estimacao_amplitude, desvio_padrao_erro_estimacao_amplitude)
